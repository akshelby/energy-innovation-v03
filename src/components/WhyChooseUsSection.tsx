        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {reasons.map((reason, i) => {
            ...
            return (
              <div
                key={reason.key}
                className="scroll-reveal text-center p-8 rounded-2xl bg-primary-foreground/10 border border-primary-foreground/10 backdrop-blur-sm transition-all duration-300"
