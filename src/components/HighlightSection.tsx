...
export default function HighlightSection() {
  ...
  return (
    <section className={`py-14 md:py-24 px-6 md:px-12 lg:px-20 bg-secondary/30 lazy-section transition-opacity duration-500 ${ready ? 'opacity-100' : 'opacity-0'}`} ref={ref}>
