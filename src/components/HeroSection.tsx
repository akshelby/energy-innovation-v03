      ...
      <div className="relative z-10 h-full flex flex-col items-center justify-center text-center px-6">
        ...
        <div className="mt-8 flex flex-wrap gap-4 justify-center animate-fade-in-up" style={{ animationDelay: "0.4s" }}>
          <Button
            ...
            className="gradient-accent text-accent-foreground rounded-full px-8 py-6 text-base font-semibold hover:bg-red-600 hover:from-red-600 hover:to-red-600 transition-all border-0"
          >
            {t("hero.explore")}
          </Button>
          <Button
