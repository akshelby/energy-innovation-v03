                                ...
                                {cat.items.map((pi) => (
                                  <li key={pi.id}>
                                    <button
                                      ...
                                      className="text-[13.5px] text-card-foreground hover:bg-accent/25 hover:text-red-500 px-2 py-1 rounded transition-colors flex items-center gap-1 group bg-transparent border-0 cursor-pointer"
                                    >
