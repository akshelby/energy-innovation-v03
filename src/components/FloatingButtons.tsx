    ...
    <div className="fixed bottom-6 right-6 z-50 flex flex-col gap-3">
      {showWhatsapp && (
        <a
          ...
          className="flex h-11 w-11 md:h-14 md:w-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-lg hover:bg-[#1DA851] transition-all hover:scale-110 active:scale-95 duration-200"
        >
          <svg viewBox="0 0 24 24" fill="currentColor" className="w-5.5 h-5.5 md:w-7 md:h-7">
