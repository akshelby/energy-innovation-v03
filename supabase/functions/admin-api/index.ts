...
Deno.serve(async (req) => {
  ...
  console.log("Auth debug:", { pwLen: password.length, viewPwLen: viewerPassword.length, adminPwLen: adminPassword.length, viewerMatch: password === viewerPassword, adminMatch: password === adminPassword });
